'use strict';
angular.module('iprpAdminApp').controller('IpProtectHomeCtrl', function ($scope,session,$location) {
    $('#nav_ip_protect').addClass("actived").parent().siblings().find('a').removeClass("actived");
