angular.module('iprpAdminApp').controller('PartnerBsOrderDetailCtrl',function($scope,$modal,bsOrderService,OrderPaymentService,BusinessesService,MemberService,ChannelBsService,$stateParams,$location){
    ...
    $scope.bsDetail = function(){
        bsOrderService.orderDetail({order_sn:$stateParams.order_sn},function(data){
            ...
            // 获取服务商
            bsOrderService.setupPartnerList({bsCode:$scope.order_detail.bs_code},{},function(data){
