angular.module('iprpAdminApp').controller('CxbOrderDetailCtrl',function($scope,$modal,cxbOrderService,OrderPaymentService,BusinessesService,MemberService,ChannelBsService,$stateParams,$location){
