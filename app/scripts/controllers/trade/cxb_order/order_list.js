angular.module('iprpAdminApp').controller('CxbOrderListCtrl',function($scope,cxbOrderService,ChannelService,PaginationService,$location,$state){
    $('#cxb_order_list').parent().siblings().children('a').removeClass("selected");
    $('#cxb_order_list').addClass("selected");
  ...
  // 添加时间控件 初始化
    ...
    $scope.detail_orders = function(index){
        $location.path('main/trade_home/cxb_order_detail/' + index);
    }
