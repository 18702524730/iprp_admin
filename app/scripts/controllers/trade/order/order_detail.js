angular.module('iprpAdminApp').controller('OrderDetailCtrl',function($scope,$modal,session,$cookies,orderService,OrderPaymentService,BusinessesService,MemberService,ChannelBsService,$stateParams,$location){
