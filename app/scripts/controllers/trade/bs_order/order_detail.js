angular.module('iprpAdminApp').controller('BsOrderDetailCtrl',function($scope,$modal,bsOrderService,OrderPaymentService,BusinessesService,MemberService,ChannelBsService,$stateParams,$location){
