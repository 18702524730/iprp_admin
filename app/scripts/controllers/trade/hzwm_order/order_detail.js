angular.module('iprpAdminApp').controller('HzwmOrderDetailCtrl',function($scope,$modal,cxbOrderService,OrderPaymentService,BusinessesService,MemberService,ChannelBsService,$stateParams,$location){
