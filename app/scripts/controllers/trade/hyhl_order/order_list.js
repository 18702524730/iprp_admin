angular.module('iprpAdminApp').controller('HyhlOrderListCtrl',function($scope,cxbOrderService,ChannelService,PaginationService,$location,$state,$rootScope){
    $('#hyhl_order_list').parent().siblings().children('a').removeClass("selected");
    $('#hyhl_order_list').addClass("selected");
  // 添加时间控件 初始化
    ...
    function init_order_list() {
      ...
      var get_applyTimeEnd = function () {
        ...
        var OweNer = function (pg_index, pg_count, cb) {
            ...
            cxbOrderService.hzhlList(object, cb);
