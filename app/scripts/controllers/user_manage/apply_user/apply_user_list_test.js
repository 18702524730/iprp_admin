angular.module('iprpAdminApp').controller('ApplyUserListTestCtrl', function ($scope,$location,MemberApplicationTestService,PaginationService) {

        $('#apply_user_list_test').siblings().removeClass("selected");
        $('#apply_user_list_test').addClass("selected");
          /**
           * 用户申请列表
           * @type {Array}
           */
         ...
         function init_member_list(){
             ...
             var OweNer = function(pg_index,pg_count,cb){
            	 MemberApplicationTestService.member_all({
                     "pg_index":pg_index,
                     "pg_count":pg_count,
