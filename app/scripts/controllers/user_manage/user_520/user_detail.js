angular.module('iprpAdminApp').controller('UserDetail520Ctrl', function ($scope,MemberService,MemberApplicationService,AssignService,$stateParams,$modal,$location) {
    ...
    //编辑主体
    $scope.editMemberSubject = function(type){//type false/冻结 true/解冻
