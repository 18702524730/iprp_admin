angular.module('iprpAdminApp').controller('MasterCzDetailCtrl',function($scope,$modal,ntOrderService,OrderPaymentService,BusinessesService,MemberService,ChannelBsService,$stateParams,$location){
