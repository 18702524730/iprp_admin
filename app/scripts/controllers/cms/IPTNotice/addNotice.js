angular.module('iprpAdminApp').controller('AddIPTNoticeCtrl',function($scope,$modal,session,$cookies,Upload,SbbService,$stateParams,$location,orderService){
  $('#sbb_IPT').addClass("selected").parent().siblings().children().removeClass("selected");

  $scope.obj = {title: '', content: '', category: 8};
