angular.module('iprpAdminApp').controller('AddTechCtrl',function($scope,$modal,session,$cookies,Upload,SbbService,$stateParams,$location,orderService){
  $('#sbb_tech').addClass("selected").parent().siblings().children().removeClass("selected");

  $scope.obj = {title: '', summary: '', category: 5, jumpType: 2};
