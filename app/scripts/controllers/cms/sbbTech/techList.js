angular.module('iprpAdminApp').controller('TechListCtrl',function($scope,$modal,SbbService,PaginationService,$stateParams,$location,Upload,$state){
...
$scope.delItem = function (id) {
  ...
  $scope.goDetailFn = function(id) {
    $state.go('main.cms_home_list.addTech', {id: id});
  };
