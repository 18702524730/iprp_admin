angular.module('iprpAdminApp').controller('StoryListCtrl',function($scope,$modal,SbbService,PaginationService,$stateParams,$location,Upload,$state){
...
$scope.delItem = function (id) {
  ...
  $scope.goDetailFn = function(id) {
    $state.go('main.cms_home_list.addStory', {id: id});
  };
