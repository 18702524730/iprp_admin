angular.module('iprpAdminApp').controller('AddBillTplDeployCtrl', function ($scope,$modal,BusinessClassService,BusinessService,BillTemplateService,BillTemplateFeedService,$stateParams,$location) {
    ...
    //编辑
    $scope.edit_tpl = function(id,index,ind){
        localStorage.setItem("bill_template_id", id);
        $modal.open({
            resolve:{
