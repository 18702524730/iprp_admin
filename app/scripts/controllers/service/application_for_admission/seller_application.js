angular.module('iprpAdminApp').controller('SellerApplicationCtrl', function ($scope,$modal,ChannelApplicationService,PaginationService,$location) {
  ...
  function init_seller_list(){
     ...
     * @param seller_id
     */
    $scope.handleClickDetail = function(seller_id){
      
      $location.path('main/merchant_home/seller_audit/'+seller_id+'/det');
    }
