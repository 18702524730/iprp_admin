angular.module('iprpAdminApp').controller('cluesReportDetailCtrl',function($scope,$modal,ipProtectService,bsOrderService,$stateParams,$location,$state,$cookies){
    $('#clues_report_list').addClass("selected").parent().siblings().children('a').removeClass("selected");
