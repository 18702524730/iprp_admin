angular.module('iprpAdminApp').controller('highTechEnterprisesCtrl',function($scope,$modal,HighTechEnterprisesService,$stateParams,$location,$state,PaginationService){
  $('#highTechEnterprises').addClass("selected").parent().siblings().children().removeClass("selected");
  ...
  $scope.apply_Info = function(){
      ...
      $location.path('main/fast_home/highTechEnterprises').search(object);
      HighTechEnterprisesService.list(object, cb);
    };
  ...
  $scope.edit= function(item){
    $modal.open({
        ...
        backdrop:false,
        keyboard:true,
        templateUrl: 'package\\modal\\fast\\editHighTech.html',
        controller: 'editHighTechCtrl'
