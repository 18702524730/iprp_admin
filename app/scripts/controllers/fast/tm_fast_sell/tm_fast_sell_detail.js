angular.module('iprpAdminApp').controller('tmFastSellDetailCtrl',function($scope, $modal, $stateParams, FeedbackService, marKetList, PaginationService,$location,$state){
    ...
    function getRemarkListFn () {
      ...
      // 查询备注列表   
      FeedbackService.fastSaleTrademarkRemarkList(params, function(data){
