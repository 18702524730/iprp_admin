angular.module('iprpAdminApp').controller('bargainDetailCtrl',function($scope, $modal, $stateParams, FeedbackService, marKetList, PaginationService,$location,$state){
    ...
    function getRemarkListFn () {
      ...
      // 查询备注列表   
      FeedbackService.bargainTrademarkRemarkList(params, function(data){
