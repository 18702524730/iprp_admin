angular.module('iprpAdminApp').controller('trademarkOtherCtrl',function($scope,$modal,InvoiceService,PaginationService,$location,$state,session){
    $('#trademark_other').addClass("selected").parent().siblings().children('a').removeClass("selected");
  ...
  // 添加时间控件 初始化
    ...
    function init_order_list() {
        ...
        var OweNer = function (pg_index, pg_count, cb) {
            ...
            InvoiceService.invoice.selectTradeMarkOther(object, cb);
            var o = $.extend({}, object);
            $location.path('main/finance_home/trademark_other').search(o);
        };
