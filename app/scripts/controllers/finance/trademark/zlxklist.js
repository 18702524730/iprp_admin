angular.module('iprpAdminApp').controller('zlxklistCtrl',function($scope,$modal,InvoiceService,PaginationService,$location,$state,session){
    $('#zlxklist').addClass("selected").parent().siblings().children('a').removeClass("selected");
    ...
    function init_order_list() {
        ...
        var OweNer = function (pg_index, pg_count, cb) {
            ...
            InvoiceService.invoice.selectPatentBook(object, cb);
            var o = $.extend({}, object);
            $location.path('main/finance_home/zlxklist').search(o);
        };
