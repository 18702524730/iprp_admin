angular.module('iprpAdminApp').controller('copyrightCtrl',function($scope,$modal,InvoiceService,PaginationService,$location,$state,session){
    $('#copyright').addClass("selected").parent().siblings().children('a').removeClass("selected");
  ...
  // 添加时间控件 初始化
    ...
    function init_order_list() {
        ...
        var OweNer = function (pg_index, pg_count, cb) {
            ...
            InvoiceService.invoice.selectSoftWare(object, cb);
            var o = $.extend({}, object);
            $location.path('main/finance_home/copyright').search(o);
        };
