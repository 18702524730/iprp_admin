angular.module('iprpAdminApp').controller('ylzllistCtrl',function($scope,$modal,InvoiceService,PaginationService,$location,$state,session){
    $('#ylzllist').addClass("selected").parent().siblings().children('a').removeClass("selected");
    ...
    function init_order_list() {
        ...
        var OweNer = function (pg_index, pg_count, cb) {
            ...
            InvoiceService.invoice.selectRemainCase(object, cb);
            var o = $.extend({}, object);
            $location.path('main/finance_home/ylzllist').search(o);
        };
