angular.module('iprpAdminApp').controller('CaseOrderDetailCtrl',function($scope,$modal,session,$cookies,ipService,OrderPaymentService,BusinessesService,MemberService,ChannelBsService,$stateParams,$location){
    $('#case_list').addClass("selected").siblings().removeClass("selected");
    ...
    var getDetail = function() {
        ipService.findSafeguardCompanyCaseDetail({orderSn:$stateParams.orderSn},function(data){
