angular.module('iprpAdminApp').controller('CzListCtrl',function($scope,ntOrderService,ChannelService,PaginationService,$location,$state){
  ...
  // 添加时间控件 初始化
    ...
    function init_order_list() {
      ...
      var OweNer = function (pg_index, pg_count, cb) {
        ...
        $location.path('main/ip_protect_home/cz_list').search(object);
      };
  ...
  $scope.search_reset = function () {
    ...
    $scope.detail_orders = function(index){
        $location.path('main/ip_protect_home/cz_detail/' + index);
    }
