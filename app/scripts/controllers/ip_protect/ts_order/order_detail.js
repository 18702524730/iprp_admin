angular.module('iprpAdminApp').controller('TsOrderDetailCtrl',function($scope,$modal,session,$cookies,ipService,OrderPaymentService,BusinessesService,MemberService,ChannelBsService,$stateParams,$location){
