angular.module('iprpAdminApp').controller('PatentOrderDetailCtrl',function($scope,$modal,session,$cookies,ipService,OrderPaymentService,BusinessesService,MemberService,ChannelBsService,$stateParams,$location){
    $('#patent_list').addClass("selected").siblings().removeClass("selected");
