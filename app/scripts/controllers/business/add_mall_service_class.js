angular.module('iprpAdminApp').controller('addMallServiceClassCtrl', function ($scope,BusinessClassService,$location) {

    $('#mall_service_class').siblings().removeClass("selected");
    $('#mall_service_class').addClass("selected");

    $scope.add_business_class_obj = { };
    $scope.bs_class_id = localStorage.getItem('mall_bs_class_id');//变量
