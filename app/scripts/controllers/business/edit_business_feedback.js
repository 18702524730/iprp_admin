angular.module('iprpAdminApp').controller('EditBusinessFeedBackCtrl', function ($scope,$modal,BusinessFeedBackService,BusinessesService,$stateParams,$location) {
...
////        $scope.businessService_detail.state = 0;
////    };
////
...
////        jq.addClass("selected");
////        jq.parent().siblings().children().removeClass("selected");
////        $scope.businessService_detail.state = 1;
////    };
//
//    $scope.edit_BusinessService = function(){
//        if(!$scope.businessService_detail.name || !$scope.businessService_detail.code){
//
//        }else{
//            BusinessesService.editBusinessService({bs_id:$stateParams.bs_id},$scope.businessService_detail,function(data){
//                $location.path('main/business_home/business_list');
//            },function(error){
//                alert(error.data.msg);
//            })
//        }
