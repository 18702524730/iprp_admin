angular.module('iprpAdminApp').controller('MemberAllotServiceCtrl', function ($scope,ServicerService,BusinessesService,PaginationService) {
    $scope.obj = { };
    init_service_list();
    function init_service_list(){
        ...
        var OweNer = function(pg_index,pg_count,cb){
            ServicerService.common_service_list({
                "pg_index":pg_index,
                "pg_count":pg_count,
